...
class CustomTasks:
    ...
    def write_task(self, agent, topic, language):
        return Task(
            ...
            agent=agent,
            output_file=f"posts/blog_post_{topic}_{language}_{datetime.now().strftime('%Y-%m-%d_%H-%M-%S')}.md",
        )
    ...
    def revision_task(self, agent, context_tasks, topic, language):
        return Task(
            ...
            output_file=f"posts/revised_blog_post_{topic}_{language}_{datetime.now().strftime('%Y-%m-%d_%H-%M-%S')}.md",
        )
